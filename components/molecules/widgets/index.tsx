...
export function KnowledgeBox({ title, description, image = "" }: TextProps) {
    return (
...
export function PortfolioBox({ title, description, link = "https://github.com/Juanda16", image = "" }: PortfolioBoxProps) {
    return (
        <div className="flex max-md:ml-0 max-md:w-full">
            <div className="flex justify-center text-lg font-medium leading-6 max-md:mt-10">
                ...
                <dialog
                    ...
                    <div className="bg-white m-auto p-8">
                        <div className="flex flex-col items-center">
                            <p>Do you want further info? , Lets talk on </p>
